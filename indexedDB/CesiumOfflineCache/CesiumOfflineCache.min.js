/*! For license information please see CesiumOfflineCache.min.js.LICENSE.txt */
var umd;
(() => {
    var e = {
            483: (e, n, t) => {
                e.exports = function e(n, t, r) {
                    ...
                    1: [function (e, n, r) {
                        (function (e) {
                            ...
                            if (o) {
                                ...
                                c.port1.onmessage = f, t = function () {
                    ...
                    2: [function (e, n, t) {
                        ...
                        n.exports = s, s.prototype.catch = function (e) {
                            ...
                            return this.state !== c ? l(t, this.state === u ? e : n, this.outcome) : this.queue.push(new f(t, e, n)), t
                            ...
                            for (var a = new Array(t), u = 0, c = -1, s = new this(o); ++c < t;) f(e[c], c);
                            return s;

                            function f(e, o) {
                                n.resolve(e).then((function (e) {
                                    a[o] = e, ++u !== t || r || (r = !0, i.resolve(s, a))
                                }), (function (e) {
                                    r || (r = !0, i.reject(s, e))
                                }))
                            }
                            ...
                            for (var u = -1, c = new this(o); ++u < r;) t = e[u], n.resolve(t).then((function (e) {
                                a || (a = !0, i.resolve(c, e))
                            }), (function (e) {
                                a || (a = !0, i.reject(c, e))
                            }));
                    ...
                    4: [function (e, n, t) {
                        ...
                        function m(e) {
                            return "boolean" == typeof d ? a.resolve(d) : function (e) {
                                return new a((function (n) {
                                    var t = e.transaction(l, p),
                                        r = i([""]);
                                    t.objectStore(l).put(r, "key"), t.onabort = function (e) {
                        ...
                        function I(e, n) {
                            return new a((function (t, r) {
                                ...
                                n && (a.onupgradeneeded = function (n) {
                                    var t = a.result;
                                    try {
                                        t.createObjectStore(e.storeName), n.oldVersion <= 1 && t.createObjectStore(l)
                                    } catch (t) {
                        ...
                        function x(e, n, t, r) {
                            ...
                            try {
                                ...
                                if (r > 0 && (!e.db || "InvalidStateError" === o.name || "NotFoundError" === o.name)) return a.resolve().then((function () {
                                    ...
                                    return function (e) {
                                        g(e);
                                        for (var n = v[e.name], t = n.forages, r = 0; r < t.length; r++) {
                                            var o = t[r];
                                            o._dbInfo.db && (o._dbInfo.db.close(), o._dbInfo.db = null)
                                        }
                                        return e.db = null, S(e).then((function (n) {
                                            return e.db = n, N(e) ? E(e) : n
                                        })).then((function (r) {
                                            e.db = n.db = r;
                        ...
                        var D = {
                            ...
                            _initStorage: function (e) {
                                ...
                                o || (o = {
                                    ...
                                    dbReady: null,
                                    deferredOperations: []
                                }, v[t.name] = o), o.forages.push(n), n._initReady || (n._initReady = n.ready, n.ready = R);
                                var i = [];
                                ...
                                for (var c = 0; c < o.forages.length; c++) {
                                    var s = o.forages[c];
                                    s !== n && i.push(s._initReady().catch(u))
                                }
                                var f = o.forages.slice(0);
                                return a.all(i).then((function () {
                                    return t.db = o.db, S(t)
                                })).then((function (e) {
                                    return t.db = e, N(t, n._defaultConfig.version) ? E(t) : e
                                })).then((function (e) {
                            ...
                            setItem: function (e, n, t) {
                                ...
                                var o = new a((function (t, o) {
                                    ...
                                    r.ready().then((function () {
                                        return i = r._dbInfo, "[object Blob]" === h.call(n) ? m(i.db).then((function (e) {
                                            return e ? n : (t = n, new a((function (e, n) {
                            ...
                            dropInstance: function (e, n) {
                                ...
                                var r, i = this;
                                if (e.name) {
                                    var c = e.name === t.name && i._dbInfo.db ? a.resolve(i._dbInfo.db) : S(e).then((function (n) {
                                        var t = v[e.name],
                                            r = t.forages;
                                        t.db = n;
                                    ...
                                    r = e.storeName ? c.then((function (n) {
                                        if (n.objectStoreNames.contains(e.storeName)) {
                                            ...
                                            return s.then((function (e) {
                                                ...
                                                for (var n = 0; n < i.length; n++) {
                                                    var t = i[n];
                                                    t._dbInfo.db = e, _(t._dbInfo)
                                                }
                                            })).catch((function (n) {
                                                throw (w(e, n) || a.resolve()).catch((function () {})), n
                                            }))
                                        }
                                    })) : c.then((function (n) {
                                        g(e);
                                        ...
                                        return u.then((function (e) {
                                            t.db = e;
                                            for (var n = 0; n < r.length; n++) _(r[n]._dbInfo)
                                        })).catch((function (n) {
                                            throw (w(e, n) || a.resolve()).catch((function () {})), n
                                        }))
                                    }))
                        ...
                        function G(e) {
                            ...
                            var s = new ArrayBuffer(a),
                                f = new Uint8Array(s);
                            for (n = 0; n < u; n += 4) t = A.indexOf(e[n]), r = A.indexOf(e[n + 1]), o = A.indexOf(e[n + 2]), i = A.indexOf(e[n + 3]), f[c++] = t << 2 | r >> 4, f[c++] = (15 & r) << 4 | o >> 2, f[c++] = (3 & o) << 6 | 63 & i;
                            return s
                        }
                        ...
                        function Q(e) {
                            var n, t = new Uint8Array(e),
                                r = "";
                            for (n = 0; n < t.length; n += 3) r += A[t[n] >> 2], r += A[(3 & t[n]) << 4 | t[n + 1] >> 4], r += A[(15 & t[n + 1]) << 2 | t[n + 2] >> 6], r += A[63 & t[n + 2]];
                            return t.length % 3 == 2 ? r = r.substring(0, r.length - 1) + "=" : t.length % 3 == 1 && (r = r.substring(0, r.length - 2) + "=="), r
                        }
                        var V = {
                            serialize: function (e, n) {
                                var t = "";
                                if (e && (t = K.call(e)), e && ("[object ArrayBuffer]" === t || e.buffer && "[object ArrayBuffer]" === K.call(e.buffer))) {
                                    var r, o = T;
                                    e instanceof ArrayBuffer ? (r = e, o += k) : (r = e.buffer, "[object Int8Array]" === t ? o += M : "[object Uint8Array]" === t ? o += F : "[object Uint8ClampedArray]" === t ? o += P : "[object Int16Array]" === t ? o += U : "[object Uint16Array]" === t ? o += q : "[object Int32Array]" === t ? o += z : "[object Uint32Array]" === t ? o += W : "[object Float32Array]" === t ? o += X : "[object Float64Array]" === t ? o += H : n(new Error("Failed to get type for BinaryArray"))), n(o + Q(r))
                                } else if ("[object Blob]" === t) {
                                    var i = new FileReader;
                                    i.onload = function () {
                                        var t = "~~local_forage_type~" + e.type + "~" + Q(this.result);
                                        n("__lfsc__:blob" + t)
                            ...
                            deserialize: function (e) {
                                if (e.substring(0, B) !== T) return JSON.parse(e);
                                var n, t = e.substring(J),
                                    r = e.substring(B, J);
                                if (r === L && C.test(t)) {
                                    var o = t.match(C);
                        ...
                        function Y(e, n, t, r, o, i) {
                            e.executeSql(t, r, o, (function (e, a) {
                                a.code === a.SYNTAX_ERR ? e.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?", [n.storeName], (function (e, u) {
                                    u.rows.length ? i(e, a) : $(e, n, (function () {
                                ...
                                o.ready().then((function () {
                                    ...
                                    c.serializer.serialize(n, (function (n, s) {
                                        s ? a(s) : c.db.transaction((function (t) {
                                            Y(t, c, "INSERT OR REPLACE INTO " + c.storeName + " (key, value) VALUES (?, ?)", [e, n], (function () {
                                                i(u)
                                            }), (function (e, n) {
                                                a(n)
                                            }))
                                            ...
                                            if (n.code === n.QUOTA_ERR) {
                                                if (r > 0) return void i(Z.apply(o, [e, u, t, r - 1]));
                                                a(n)
                                            }
                                        }))
                                    }))
                        ...
                        var ne = {
                                    ...
                                    r = new a((function (n, r) {
                                        t.ready().then((function () {
                                            ...
                                            o.db.transaction((function (t) {
                                                Y(t, o, "SELECT * FROM " + o.storeName, [], (function (t, r) {
                                                    for (var i = r.rows, a = i.length, u = 0; u < a; u++) {
                                                        var c = i.item(u),
                                                            s = c.value;
                                                        if (s && (s = o.serializer.deserialize(s)), void 0 !== (s = e(s, c.key, u + 1))) return void n(s)
                                                    }
                                                    n()
                                                }), (function (e, n) {
                                                    r(n)
                            ...
                            getItem: function (e, n) {
                                ...
                                var r = new a((function (n, r) {
                                    t.ready().then((function () {
                                        var o = t._dbInfo;
                                        o.db.transaction((function (t) {
                                            Y(t, o, "SELECT * FROM " + o.storeName + " WHERE key = ? LIMIT 1", [e], (function (e, t) {
                            ...
                            removeItem: function (e, n) {
                                ...
                                var r = new a((function (n, r) {
                                    t.ready().then((function () {
                                        var o = t._dbInfo;
                                        o.db.transaction((function (t) {
                                            Y(t, o, "DELETE FROM " + o.storeName + " WHERE key = ?", [e], (function () {
                                                n()
                                            }), (function (e, n) {
                                                r(n)
                                            }))
                                    ...
                                    t = new a((function (e, t) {
                                        n.ready().then((function () {
                                            ...
                                            r.db.transaction((function (n) {
                                                Y(n, r, "DELETE FROM " + r.storeName, [], (function () {
                                                    e()
                                                }), (function (e, n) {
                                                    t(n)
                                                }))
                                ...
                                var n = this,
                                    t = new a((function (e, t) {
                                        n.ready().then((function () {
                                            var r = n._dbInfo;
                                            r.db.transaction((function (n) {
                                                Y(n, r, "SELECT COUNT(key) as c FROM " + r.storeName, [], (function (n, t) {
                                ...
                                var t = this,
                                    r = new a((function (n, r) {
                                        t.ready().then((function () {
                                            var o = t._dbInfo;
                                            o.db.transaction((function (t) {
                                                Y(t, o, "SELECT key FROM " + o.storeName + " WHERE id = ? LIMIT 1", [e + 1], (function (e, t) {
                                ...
                                var n = this,
                                    t = new a((function (e, t) {
                                        n.ready().then((function () {
                                            var r = n._dbInfo;
                                            r.db.transaction((function (n) {
                                                Y(n, r, "SELECT key FROM " + r.storeName, [], (function (n, t) {
                            ...
                            dropInstance: function (e, n) {
                                ...
                                (e = "function" != typeof e && e || {}).name || (e.name = e.name || t.name, e.storeName = e.storeName || t.storeName);
                                var r, o = this;
                                return u(r = e.name ? new a((function (n) {
                                    var r;
                                ...
                                })) : a.reject("Invalid arguments"), n), r
                            }
                        };
                        ...
                        var oe = {
                                ...
                                _initStorage: function (e) {
                                    ...
                                    return n.keyPrefix = te(e, this._defaultConfig), re() ? (this._dbInfo = n, n.serializer = V, a.resolve()) : a.reject()
                                },
                                _support: function () {
                                    try {
                                        ...
                                        r = t.ready().then((function () {
                                            for (var n = t._dbInfo, r = n.keyPrefix, o = r.length, i = localStorage.length, a = 1, u = 0; u < i; u++) {
                                                ...
                                                if (0 === c.indexOf(r)) {
                                                    ...
                                                    if (s && (s = n.serializer.deserialize(s)), void 0 !== (s = e(s, c.substring(o), a++))) return s
                                                }
                                            }
                                        }));
                                    return u(r, n), r
                                ...
                                dropInstance: function (e, n) {
                                    if (n = f.apply(this, arguments), !(e = "function" != typeof e && e || {}).name) {
                                        var t = this.config();
                                        e.name = e.name || t.name, e.storeName = e.storeName || t.storeName
                                    }
                                    var r, o = this;
                                    return r = e.name ? new a((function (n) {
                                        e.storeName ? n(te(e, o._defaultConfig)) : n(e.name + "/")
                                    })).then((function (e) {
                                        for (var n = localStorage.length - 1; n >= 0; n--) {
                                            var t = localStorage.key(n);
                                            0 === t.indexOf(e) && localStorage.removeItem(t)
                                        }
                                    })) : a.reject("Invalid arguments"), u(r, n), r
                                }
                            },
                            ie = function (e, n) {
                                for (var t = e.length, r = 0; r < t;) {
                                    if ((o = e[r]) === (i = n) || "number" == typeof o && "number" == typeof i && isNaN(o) && isNaN(i)) return !0;
                                    r++
                                }
                                var o, i;
                                return !1
                            ...
                            fe = [se.INDEXEDDB._driver, se.WEBSQL._driver, se.LOCALSTORAGE._driver],
                            le = ["dropInstance"],
                        ...
                        function ye() {
                            for (var e = 1; e < arguments.length; e++) {
                                var n = arguments[e];
                                if (n)
                                    for (var t in n) n.hasOwnProperty(t) && (ae(n[t]) ? arguments[0][t] = n[t].slice() : arguments[0][t] = n[t])
                            }
                            return arguments[0]
                        }
                        var pe = function () {
                                function e(n) {
                                    for (var t in function (e, n) {
                                        ...
                                        } this._defaultConfig = ye({}, ve), this._config = ye({}, this._defaultConfig, n), this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver).catch((function () {}))
                                }
                                return e.prototype.config = function (e) {
                                    ...
                                    var r = new a((function (n, t) {
                                        try {
                                            ...
                                            for (var i = de.concat("_initStorage"), c = 0, s = i.length; c < s; c++) {
                                                var f = i[c];
                                                if ((!ie(le, f) || e[f]) && "function" != typeof e[f]) return void t(o)
                                            }! function () {
                                                for (var n = function (e) {
                                                    ...
                                                    }, t = 0, r = le.length; t < r; t++) {
                                                    var o = le[t];
                                                    e[o] || (e[o] = n(o))
                                                }
                                            }();
                                            var l = function (t) {
                                                ue[r] && console.info("Redefining LocalForage driver: " + r), ue[r] = e, ce[r] = t, n()
                                            };
                                            "_support" in e ? e._support && "function" == typeof e._support ? e._support().then(l, t) : l(!!e._support) : l(!0)
                                        } catch (e) {
                                            t(e)
                                        }
                                    }));
                                    ...
                                    var r = ue[e] ? a.resolve(ue[e]) : a.reject(new Error("Driver not found."));
                                    return c(r, n, t), r
                                            ...
                                            r._driver = e._driver, i(), r._wrapLibraryMethodsWithReady(), r._initDriver = function (e) {
                                                return function () {
                                                    ...
                                                    return function t() {
                                                        for (; n < e.length;) {
                                                            var o = e[n];
                                                            return n++, r._dbInfo = null, r._ready = null, r.getDriver(o).then(u).catch(t)
                                                        }
                                                        i();
                                    ...
                                    })), c(this._driverSet, n, t), this._driverSet
                                    ...
                                    for (var e = 0, n = de.length; e < n; e++) he(this, de[e])
    ...
    (() => {
        ...
        let o = [];
        o[0] = 2023;
        let i = n().createInstance({
            name: "CesiumOfflineCache"
        });
        const a = {
            async initLicence() {
                o[1] = 4, o[2] = 1, await n().setDriver(n().INDEXEDDB)
            },
            async initCacheProxy() {
                ! function () {
                    if (!window.Cesium) return;
                    // let e = (new Date(o.join("-")) - new Date) / 1e3 / 3600 / 24;
                    // if (e = Math.floor(100 * e) / 100, !(e > 0)) return console.warn("CesiumOfflineCache 数据高速缓存插件，使用期已结束，请获取授权。"), void a.clear().then();
                    // console.log("%cCesiumOfflineCache 数据高速缓存插件，还可使用 " + e + " 天", "color:green"), a.getUseSize().then();
                    let n = Cesium.Resource,
                        t = Cesium.RequestErrorEvent,
                        r = Cesium.RuntimeError,
                        i = Cesium.TrustedServers,
                        u = Cesium.defined,
                        c = Cesium.defaultValue;
                    const s = /^data:(.*?)(;base64)?,(.*)$/;
                    ...
                    n._Implementations.loadWithXhr = function (e, n, o, d, v, h, y) {
                        console.log('loadWithXhr',e);
                        const p = s.exec(e),
                            b = JSON.stringify({
                                url: e,
                                responseType: n,
                        ...
                        if (null !== p) return void h.resolve(function (e, n) {
                            n = c(n, "");
                            const t = e[1],
                                r = !!e[2],
                                o = e[3];
                            ...
                            switch (n) {
                                ...
                                case "arraybuffer":
                                    return f(r, o);
                                case "blob":
                                    return i = f(r, o), new Blob([i], {
                                        type: t
                                    });
                                case "document":
                                    return a = new DOMParser, a.parseFromString(l(r, o), t);
                                case "json":
                                    return JSON.parse(l(r, o));
                                default:
                                    throw new DeveloperError(`Unhandled responseType: ${n}`)
                            }
                        }(p, n));
                        const m = new XMLHttpRequest;
                        if (a.judgeUrl(e) && a.getItem(b).then((e => e ? h.resolve(e) : m.send(d))), i.contains(e) && (m.withCredentials = !0), m.open(o, e, !0), u(y) && u(m.overrideMimeType) && m.overrideMimeType(y), u(v))
                            for (const e in v) v.hasOwnProperty(e) && m.setRequestHeader(e, v[e]);
                        u(n) && (m.responseType = n);
                        let g = !1;
                        return "string" == typeof e && (g = 0 === e.indexOf("file://") || "undefined" != typeof window && "file://" === window.location.origin), m.onload = function () {
                            if ((m.status < 200 || m.status >= 300) && (!g || 0 !== m.status)) return void h.reject(new t(m.status, m.response, m.getAllResponseHeaders()));
                            const e = m.response,
                                i = m.responseType;
                            if ("HEAD" === o || "OPTIONS" === o) {
                                const e = m.getAllResponseHeaders().trim().split(/[\r\n]+/),
                                    n = {};
                            ...
                            if (204 === m.status) h.resolve();
                            else if (!u(e) || u(n) && i !== n)
                                if ("json" === n && "string" == typeof e) try {
                                    let n = JSON.parse(e);
                                    a.setItem(b, n).then((() => h.resolve(n)))
                                } catch (e) {
                                    h.reject(e)
                                } else("" === i || "document" === i) && u(m.responseXML) && m.responseXML.hasChildNodes() ? a.setItem(b, m.responseXML).then((() => h.resolve(m.responseXML))) : "" !== i && "text" !== i || !u(m.responseText) ? h.reject(new r("Invalid XMLHttpRequest response type.")) : a.setItem(b, m.responseText).then((() => h.resolve(m.responseText)));
                                else a.setItem(b, e).then((() => h.resolve(e)))
                        }, m.onerror = function (e) {
                            h.reject(new t)
                        }, a.judgeUrl(e) || m.send(d), m
                    }
                }()
            },
            ruleList: new Set,
            judgeUrl(e) {
                let n = !1;
                console.log('e',this.ruleList);
                return [...this.ruleList].forEach((t => n = n || e.indexOf(t) > -1 || "*" === t)), n
            },
            getItem: async e => await i.getItem(e),
            async setItem(e, n) {
                let t = JSON.parse(e);
                return !!(this.judgeUrl(t.url) && e && n) && await i.setItem(e, n)
            },
            keys: async () => await i.keys(),
            async clear() {
                await i.clear()
            },
            async getUseSize() {
                const e = await navigator.storage.estimate(),
                    n = e.usage / e.quota * 100;
                let t = e.usage / 1024 / 1024;
                t = t > 1024 ? t / 1024 + " GB" : t.toFixed(2) + " MB";
                const r = n.toFixed(2),
                    o = ((e.quota - e.usage) / 1024 / 1024 / 1024).toFixed(2);
                return console.log(`%c浏览器 IndexDB 已使用 ${t}，占最大可用容量 ${r} % 。最多可以再写入 ${o} GB。`, "color:green"), e
            }
        };
        (async () => {
            await a.initLicence(), await a.initCacheProxy()
        })(), window.localforage = n(), window.CesiumOfflineCache = a;
        const u = a
    })(), umd = r.default
})();